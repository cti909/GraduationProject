...
namespace AgriSystem.Service.VNPayService
{
    public class VnPayLibrary
    {
        ...
        public string CreateRequestUrl(Uri baseUrl, string vnp_HashSecret)
        {
            ...
            string baseUrlApi = baseUrl.AbsoluteUri;
            ...
            baseUrlApi += "vnp_SecureHash=" + vnp_SecureHash;
    ...
    public static class Utils
    {
        ...
        public static string GetIpAddress()
        {
            ...
            try
            {
                ...
                {
                    ipAddress = Dns.GetHostEntry(Dns.GetHostName()).AddressList[0].ToString(); // Request.ServerVariables["REMOTE_ADDR"];
                }
            }
            catch (Exception ex)
            {
